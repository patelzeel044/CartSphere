...
import { selectUserInfo,fetchLoggedInUserOrderAsync, selectUserOrders } from './userSlice';
    ...
    <div>
      ...
      <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          <div className="flex justify-between border-2 border-solid p-5 m-2 border-gray-200 gap-x-6 py-5">
                        ...
                        <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                          ...
                          <p className="mt-1 text-xs leading-5 text-gray-500">{order.selectedAddress.phone} </p>
                        </div>
                      </div>
